app.controller('BackOfficeUserMissionsCtrl', ['$scope', '$http', '$log', '$location', '$routeParams', '$rootScope', '$window',
    function ($scope, $http, $log, $location, $routeParams, $rootScope, $window) {
        'use strict';
            ...
            if ($window.confirm("Êtes vous sur de vouloir désaffecter cette mission ?")) {
                ...
                $http({
                    ...
                    .success(function (result) {
                        $rootScope.onSuccess("Mission désaffectée.");
